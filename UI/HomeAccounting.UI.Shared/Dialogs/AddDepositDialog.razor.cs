...
public partial class AddDepositDialog : IDisposable
{
    private readonly CancellationTokenSource _cts = new();

    private readonly CreateDepositModel _model = new();
    ...
    [Inject] private IDepositService DepositService { get; set; } = null!;
    ...
    private async Task OnSubmitAsync()
    {
        ...
        await DepositService.CreateDepositAsync(_model, _cts.Token);
