...
public partial class UpdateDepositDialog
{
    private readonly CancellationTokenSource _cts = new();

    private readonly UpdateDepositModel _model = new();
    ...
    [Parameter]
    public DepositView SelectedDeposit { get; set; } = null!;
    ...
    protected override Task OnInitializedAsync()
    {
        ...
        _model.DepositId = SelectedDeposit.Id;
    ...
    private async Task OnSubmitAsync()
    {
        ...
        await DepositService.UpdateDepositAsync(_model, _cts.Token);
