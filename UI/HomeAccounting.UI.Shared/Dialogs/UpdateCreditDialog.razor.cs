...
public partial class UpdateCreditDialog
{
    private readonly CancellationTokenSource _cts = new();

    private readonly UpdateCreditModel _model = new();
    ...
    [Parameter]
    public CreditView SelectedCredit { get; set; } = null!;
    ...
    protected override Task OnInitializedAsync()
    {
        ...
        _model.CreditId = SelectedCredit.Id;
    ...
    private async Task OnSubmitAsync()
    {
        ...
        await CreditService.UpdateCreditAsync(_model, _cts.Token);
