...
public partial class AddIncomingDialog : IDisposable
{
    private readonly CancellationTokenSource _cts = new();

    private readonly CreateIncomingModel _model = new();
    ...
    private async Task OnSubmitAsync()
    {
        ...
        await IncomingService.CreateIncomingAsync(_model, _cts.Token);
